...
public class LoversSiteTestFunnySocks_5 {
...
//    тегу и классу одновременно. Элементы с двумя классами ищите по ID, тегу и двум классам.
    ...
    private By buttonToComeIn = By.cssSelector("button#submit.form-submit");
    private By resultFormErrorLocator = By.cssSelector("pre#error.form-error-password-email");
